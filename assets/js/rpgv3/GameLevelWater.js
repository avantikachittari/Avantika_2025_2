...
class GameLevelWater {
  constructor(path) {
    ...
    // Background data
    const image_src_water = path + "/images/rpg/sky.jpg";
    ...
    const TURTLE_SCALE_FACTOR = 7;
    const sprite_src_turtle = path + "/images/rpg/moth.png";
    const sprite_data_turtle = {
        ...
        pixels: {height: 606, width: 920},
        orientation: {rows: 4, columns: 5 },
        down: {row: 3, start: 0, columns: 1 },
        left: {row: 1, start: 0, columns: 1 },
        right: {row: 0, start: 0, columns: 1 },
        up: {row: 2, start: 0, columns: 1 },
    };
